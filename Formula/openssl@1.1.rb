class OpensslAT11 < Formula
  ...
  mirror "https://dl.bintray.com/homebrew/mirror/openssl-1.1.1d.tar.gz"
  mirror "https://www.mirrorservice.org/sites/ftp.openssl.org/source/old/1.1.1/openssl-1.1.1d.tar.gz"
